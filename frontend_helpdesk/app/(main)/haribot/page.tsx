      ...
      <div className="relative h-screen flex flex-col bg-stone-50 dark:bg-[#121212] text-gray-900 dark:text-gray-100 transition-colors duration-300 font-sans overflow-hidden">
        ...
        <main className="relative z-10 flex-1 flex flex-col max-w-4xl w-full mx-auto overflow-hidden">
          ...
          <div className="absolute bottom-6 left-0 right-0 px-4 sm:px-8">
            <div className="max-w-3xl mx-auto bg-white dark:bg-[#18181b] p-2 pl-4 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.08)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.3)] border border-gray-100 dark:border-white/10 flex items-center gap-2">
            ...
            <p className="text-center text-[10px] text-gray-400 mt-3">
              SHOULD I ADD THIS HERE: Haribot may display inaccurate info, so please verify important details with the Registrar.
            </p>
          </div>
