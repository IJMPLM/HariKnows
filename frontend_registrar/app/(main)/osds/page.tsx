...
// ─── Types ────────────────────────────────────────────────────────────────────
type DocType = "no-record" | "minor" | "major";
...
const DOC_TYPES: { value: DocType; label: string; short: string }[] = [
  { value: "no-record", label: "No Record",      short: "No Record"      },
  { value: "minor",     label: "Minor Offense",  short: "Minor"          },
  { value: "major",     label: "Major Offense",  short: "Major"          },
];
...
const SORT_OPTIONS: { value: SortOrder; label: string }[] = [
  { value: "doc-asc",   label: "Record Type (A → Z)" },
  { value: "doc-desc",  label: "Record Type (Z → A)" },
...
const INITIAL_SUBMITTED: SubmittedFile[] = [
  { id:"DOC-0001", type:"no-record", title:"Student Clearance – No Disciplinary Record",  ay:"AY 2024-2025", dateSubmitted:"Jan 10, 2025", filename:"Clearance_NoRecord_AY2024-2025.csv" },
  { id:"DOC-0002", type:"minor",     title:"Minor Offense Report – Tardiness Case",      ay:"AY 2023-2024", dateSubmitted:"Mar 5, 2024",  filename:"MinorOffense_Tardiness_2024.csv" },
  { id:"DOC-0003", type:"major",     title:"Major Offense Report – Academic Misconduct", ay:"AY 2023-2024", dateSubmitted:"Aug 20, 2024", filename:"MajorOffense_Misconduct_2024.csv" },
  { id:"DOC-0004", type:"no-record", title:"Student Clearance – No Disciplinary Record",  ay:"AY 2024-2025", dateSubmitted:"Feb 1, 2025",  filename:"Clearance_NoRecord_02_AY2024-2025.csv" },
];

const INITIAL_DEFICIENCIES: Deficiency[] = [
  { id:"DEF-0001", type:"minor",     title:"Minor Offense Report – Class Disruption",  ay:"AY 2024-2025", dueDate:"Mar 31, 2025", status:"not-submitted" },
  { id:"DEF-0002", type:"major",     title:"Major Offense Report – Cheating Incident", ay:"AY 2023-2024", dueDate:"Jun 15, 2024", status:"overdue" },
];
...
export default function OSDPage() {
  ...
  const handleUpload = async () => {
    if (!selectedType) { setToast({ type: "warning", message: "Please select a record type." });  return; }
    ...
    setUploading(false);
    setToast({ type: "success", message: `${docMeta.short} uploaded successfully for ${selectedAY}!` });
    closeModal();
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-[var(--line)]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-[0.95rem] text-[var(--text)]">Upload Disciplinary Record</p>
        ...
        >
          ...
          >
            ...
            <h1 className="text-2xl lg:text-[1.75rem] font-extrabold tracking-tight leading-tight text-[var(--text)]">
              Office of Student{" "}
              <span className="text-[#e8834a]">Discipline</span>
            </h1>
            <p className="mt-1 text-sm text-[var(--muted)]">
              Upload and track disciplinary documents for the office.
            </p>
                    ...
                    {filteredSubmitted.length === 0 ? (
                      ...
                      >
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                          <div className="w-9 h-9 rounded-xl bg-[#e8834a]/15 flex items-center justify-center flex-shrink-0">
                            <FileSpreadsheet size={15} className="text-[#e8834a]" />
                          </div>
                          <div className="min-w-0">
                            <p className="text-[11px] font-mono font-bold text-[#e8834a]">{file.id}</p>
