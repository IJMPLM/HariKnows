...
const DOC_TYPES: { value: DocType; label: string; short: string }[] = [
  { value: "cwts", label: "CWTS - Civic Welfare Training Service",  short: "CWTS" },
  { value: "lts",  label: "LTS - Literacy Training Service",        short: "LTS"  },
  { value: "rotc", label: "ROTC - Reserve Officers' Training Corps", short: "ROTC" },
];
...
const SORT_OPTIONS: { value: SortOrder; label: string }[] = [
  { value: "doc-asc",   label: "Component (A \u2192 Z)" },
  { value: "doc-desc",  label: "Component (Z \u2192 A)" },
...
const INITIAL_SUBMITTED: SubmittedFile[] = [
  { id:"DOC-0001",type:"cwts", title:"List of NSTP Completers", ay:"AY 2024-2025",dateSubmitted:"Jan 15, 2025",filename:"CWTS_Completers_2024-2025.csv" },
  { id:"DOC-0002",type:"lts",  title:"List of NSTP Completers", ay:"AY 2023-2024",dateSubmitted:"Jun 10, 2024",filename:"LTS_Completers_2023-2024.csv" },
  { id:"DOC-0003",type:"rotc", title:"List of NSTP Completers", ay:"AY 2023-2024",dateSubmitted:"Jan 18, 2024",filename:"ROTC_Completers_2023-2024.csv" },
  { id:"DOC-0004",type:"cwts", title:"List of NSTP Completers", ay:"AY 2023-2024",dateSubmitted:"Jan 22, 2024",filename:"CWTS_Completers_2023-2024.csv" },
  { id:"DOC-0005",type:"lts",  title:"List of NSTP Completers", ay:"AY 2024-2025",dateSubmitted:"Jan 23, 2025",filename:"LTS_Completers_2024-2025.csv" },
];

const INITIAL_DEFICIENCIES: Deficiency[] = [
  { id:"DEF-0001",type:"rotc", title:"List of NSTP Completers", ay:"AY 2024-2025",dueDate:"Jun 30, 2025",status:"not-submitted" },
  { id:"DEF-0002",type:"cwts", title:"List of NSTP Completers", ay:"AY 2022-2023",dueDate:"Mar 1, 2023", status:"overdue"       },
  { id:"DEF-0003",type:"lts",  title:"List of NSTP Completers", ay:"AY 2022-2023",dueDate:"Mar 1, 2023", status:"overdue"       },
];
...
function CustomSelect({
  ...
  return (
    <div ref={ref} className="relative w-full">
      ...
      >
        <span className={`truncate ${selected ? "text-[var(--text)]" : "text-[var(--muted)]"}`}>
...
export default function NSTPPage() {
  ...
  const handleUpload = async () => {
    if (!selectedType) { setToast({ type: "warning", message: "Please select a program component." });  return; }
    ...
    setUploading(false);
    setToast({ type: "success", message: `List of Completers uploaded successfully for ${docMeta.short} (${selectedAY})!` });
    closeModal();
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-[var(--line)]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-[0.95rem] text-[var(--text)]">Upload List of Completers</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  <label htmlFor="modal-doc-type" className="block text-[11px] font-bold uppercase tracking-widest text-[var(--muted)]">
                    Program Component <span className="text-red-500">*</span>
                  </label>
                  <CustomSelect
                    id="modal-doc-type"
                    value={selectedType}
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 text-[11px] font-semibold uppercase tracking-widest text-[var(--muted)] mb-2">
              ...
              NSTP · File Management
            </div>

            <h1 className="text-2xl lg:text-[1.75rem] font-extrabold tracking-tight leading-tight text-[var(--text)]">
              National Service{" "}
              <span className="text-[#6e3102] dark:text-[#d4855a]">Training Program</span>
            </h1>
            <p className="mt-1 text-sm text-[var(--muted)]">
              Upload and track NSTP Completers for the program.
            </p>
