...
const INITIAL_SUBMITTED: SubmittedFile[] = [
  ...
  { id:"DOC-0009",type:"curriculum", title:"Curriculum - BS Nursing",        ay:"AY 2024-2025",dateSubmitted:"Aug 2, 2024", filename:"Curriculum_BSCS_2024-2025.csv"  },
  { id:"DOC-0010",type:"syllabus",   title:"Syllabus - NS201: Introduction to Nursing",      ay:"AY 2023-2024",dateSubmitted:"Aug 8, 2023", filename:"Syllabus_IS201_2023-2024.csv"   },
];
        ...
        >
          ...
          >
            ...
            <h1 className="text-2xl lg:text-[1.75rem] font-extrabold tracking-tight leading-tight text-[var(--text)]">
              College of {" "}
              <span className="text-[#6e3102] dark:text-[#d4855a]">Nursing</span>
            </h1>
